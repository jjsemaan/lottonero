...
os.environ['STRIPE_ENDPOINT_SECRET'] = 'whsec_ypKEFXNzBNfHFAgsQdrwkGGkOGnr3Z9t'
os.environ['STRIPE_PRICING_TABLE_ID'] ='prctbl_1PRy3kRqKPcp1RrsSNlyexrM'
os.environ['DJSTRIPE_WEBHOOK_SECRET'] = 'your_stripe_webhook_secret' # not recommended and will be removed in the future
