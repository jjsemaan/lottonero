...
PREDICTIONS_STRIPE_PRICING_TABLE_ID = os.environ.get('PREDICTIONS_STRIPE_PRICING_TABLE_ID')
STATISTICS_STRIPE_PRICING_TABLE_ID = os.environ.get('STATISTICS_STRIPE_PRICING_TABLE_ID')
...
#'VERY IMPORTANT - DEFAULT_FILE_STORAGE is deprecated and will be replaced by STORAGES IN Django 5.1'
